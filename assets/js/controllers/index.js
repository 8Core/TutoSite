//var todoApp = angular.module('StarterApp', ['ngMaterial']);

todoApp.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
...
todoApp.controller('ListBottomSheetCtrl', function($scope, $mdBottomSheet) {
  $scope.items = [
...
todoApp.controller('DemoCtrl', DemoCtrl);
...
todoApp.config(function($mdThemingProvider) {
